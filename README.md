...
* [nvm](https://github.com/creationix/nvm) ⭐ 94,871 | 🐛 389 | 🌐 Shell | 📅 2026-09-04 / [n](https://github.com/tj/n) ⭐ 19,514 | 🐛 5 | 🌐 Shell | 📅 2026-08-30 - Node version manager for macOS/Linux.
* [nvm-windows](https://github.com/coreybutler/nvm-windows) ⭐ 47,574 | 🐛 3 | 🌐 Inno Setup | 📅 2026-09-04 - Manage multiple installations of Node.js on a Windows computer.
...
* [Redis](https://github.com/tporadowski/redis) ⭐ 10,254 | 🐛 82 | 🌐 C | 📅 2026-09-04 - Native port of Redis for Windows.
...
* [shelljs](https://github.com/shelljs/shelljs) ⭐ 14,401 | 🐛 105 | 🌐 JavaScript | 📅 2026-08-12 - Cross-platform Unix shell commands.
* [execa](https://github.com/sindresorhus/execa) ⭐ 7,601 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-31 - Cross-platform implementation of `child_process.{execFile,exec}`.
...
* [chokidar](https://github.com/paulmillr/chokidar) ⭐ 12,231 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-16 - Improved cross-platform file watching.
