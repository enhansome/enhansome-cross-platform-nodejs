...
* [nvm-windows](https://github.com/coreybutler/nvm-windows) ⭐ 47,498 | 🐛 87 | 🌐 Go | 📅 2026-08-26 - Manage multiple installations of Node.js on a Windows computer.
...
* [systeminformation](https://github.com/sebhildebrandt/systeminformation) ⭐ 3,130 | 🐛 58 | 🌐 JavaScript | 📅 2026-08-28 - Hardware/software system information.
...
* [fs-extra](https://github.com/jprichardson/node-fs-extra) ⭐ 9,594 | 🐛 13 | 🌐 JavaScript | 📅 2026-07-23 - Combines `graceful-fs` with better JSON file reading and promises.
