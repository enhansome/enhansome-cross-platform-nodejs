...
* [nvm](https://github.com/creationix/nvm) ⭐ 95,177 | 🐛 392 | 🌐 Shell | 📅 2026-09-21 / [n](https://github.com/tj/n) ⭐ 19,511 | 🐛 5 | 🌐 Shell | 📅 2026-08-30 - Node version manager for macOS/Linux.
* [nvm-windows](https://github.com/coreybutler/nvm-windows) ⭐ 47,787 | 🐛 3 | 🌐 Inno Setup | 📅 2026-09-24 - Manage multiple installations of Node.js on a Windows computer.
...
* [systeminformation](https://github.com/sebhildebrandt/systeminformation) ⭐ 3,137 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-22 - Hardware/software system information.
...
* [chokidar](https://github.com/paulmillr/chokidar) ⭐ 12,244 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-16 - Improved cross-platform file watching.
* [fs-extra](https://github.com/jprichardson/node-fs-extra) ⭐ 9,590 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-22 - Combines `graceful-fs` with better JSON file reading and promises.
* [rimraf](https://github.com/isaacs/rimraf) ⭐ 5,852 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-15 / [del](https://github.com/sindresorhus/del) ⭐ 1,343 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-21 - Delete files and folders. Cross-platform.
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,513 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 - Opens stuff like websites, files, executables. Cross-platform.
